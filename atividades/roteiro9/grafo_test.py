...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.lic_letras.adicionaAresta('d1', '11', '21')
        self.lic_letras.adicionaAresta('d3', '11', '22')
        self.lic_letras.adicionaAresta('d5', '12', '23')
        self.lic_letras.adicionaAresta('d8', '12', '25')
        self.lic_letras.adicionaAresta('d8', '17', '26')
        self.lic_letras.adicionaAresta('d9', '21', '31')
        self.lic_letras.adicionaAresta('d10', '21', '32')
        self.lic_letras.adicionaAresta('d10', '21', '33')
        self.lic_letras.adicionaAresta('d11', '24', '34')
        self.lic_letras.adicionaAresta('d12', '25', '35')
        self.lic_letras.adicionaAresta('d13', '31', '41')
        self.lic_letras.adicionaAresta('d14', '33', '42')
        self.lic_letras.adicionaAresta('d15', '25', '43')
        self.lic_letras.adicionaAresta('d16', '25', '44')
        self.lic_letras.adicionaAresta('d17', '36', '44')
        self.lic_letras.adicionaAresta('d171', '23', '46')
        self.lic_letras.adicionaAresta('d172', '35', '46')
        self.lic_letras.adicionaAresta('d173', '37', '47')
        self.lic_letras.adicionaAresta('d18', '31', '51')
        self.lic_letras.adicionaAresta('d19', '35', '52')
        self.lic_letras.adicionaAresta('d20', '13', '53')
        self.lic_letras.adicionaAresta('d21', '45', '54')
        self.lic_letras.adicionaAresta('d22', '35', '55')
        self.lic_letras.adicionaAresta('d23', '22', '56')
        self.lic_letras.adicionaAresta('d26', '43', '57')
        self.lic_letras.adicionaAresta('d27', '31', '61')
        self.lic_letras.adicionaAresta('d28', '31', '62')
        self.lic_letras.adicionaAresta('d30', '35', '63')
        self.lic_letras.adicionaAresta('d32', '54', '64')
        self.lic_letras.adicionaAresta('d34', '37', '67')
        self.lic_letras.adicionaAresta('d35', '54', '68')
        self.lic_letras.adicionaAresta('d36', '31', '71')
        self.lic_letras.adicionaAresta('d37', '31', '72')
        self.lic_letras.adicionaAresta('d39', '31', '73')
        self.lic_letras.adicionaAresta('d40', '64', '74')
        self.lic_letras.adicionaAresta('d41', '35', '75')
        self.lic_letras.adicionaAresta('d51', '45', '76')
        self.lic_letras.adicionaAresta('d52', '27', '77')
        self.lic_letras.adicionaAresta('d53', '53', '77')
        self.lic_letras.adicionaAresta('d54', '64', '78')
        self.lic_letras.adicionaAresta('d55', '68', '78')
        self.lic_letras.adicionaAresta('d44', '17', '83')
        self.lic_letras.adicionaAresta('d45', '74', '84')
        self.lic_letras.adicionaAresta('d48', '77', '87')
        self.lic_letras.adicionaAresta('d49', '74', '88')
        self.lic_letras.adicionaAresta('d50', '78', '88')

        self.lic_letras_gabarito = [
            '11', '12', '13', '14', '15', '16', '17',
            '24', '27', '36', '37', '45', '65', '66',
            '81', '82', '85', '86', '21', '22', '23',
            '25', '26', '34', '47', '53', '54', '67',
            '76', '83', '31', '32', '33', '35', '43',
            '44', '56', '64', '68', '77', '41', '42',
            '46', '51', '52', '55', '57', '61', '62',
            '63', '71', '72', '73', '74', '75', '78',
            '87', '84', '88']
    ...
    def test_kahn(self):
        ...
        self.assertListEqual(self.lic_letras.kahn(), self.lic_letras_gabarito)